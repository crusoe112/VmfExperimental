 ...
 *
 */
class RadamsaRepeatByteMutator: public MutatorModule, public RadamsaByteMutatorBase
{
    public:
        ...
        RadamsaRepeatByteMutator(std::string name);
        virtual ~RadamsaRepeatByteMutator();
