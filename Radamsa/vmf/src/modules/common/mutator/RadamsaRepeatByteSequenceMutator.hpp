...
class RadamsaRepeatByteSequenceMutator: public MutatorModule, public RadamsaByteMutatorBase
{
    ...
    private:
        ...
        // Per-call upper bound on `seq_len * numberOfRepetitions` bytes added to the output buffer. Default 16777216 (16 MiB). Set the `maxBufferGrowthBytes` config key to override; 0 disables the cap.
