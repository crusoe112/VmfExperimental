...
REGISTER_MODULE(RadamsaDecrementByteMutator);
 ...
 */
Module* RadamsaDecrementByteMutator::build(std::string name)
{
    return new RadamsaDecrementByteMutator(name);
}
 ...
 */
void RadamsaDecrementByteMutator::init(ConfigInterface& config)
{

}

/**
 * @brief Construct a new RadamsaDecrementByteMutator::RadamsaDecrementByteMutator object
 *
 * @param name The of the name module
 */
RadamsaDecrementByteMutator::RadamsaDecrementByteMutator(std::string name) : MutatorModule(name)
{
    // rand->randInit();
}

/**
 * @brief Destroy the RadamsaDecrementByteMutator::RadamsaDecrementByteMutator object
 *
 */
RadamsaDecrementByteMutator::~RadamsaDecrementByteMutator()
{
 ...
 */
void RadamsaDecrementByteMutator::registerStorageNeeds(StorageRegistry& registry)
{
