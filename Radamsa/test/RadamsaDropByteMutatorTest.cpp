...
class RadamsaDropByteMutatorTest : public ::testing::Test {
  protected:
    RadamsaDropByteMutatorTest() 
    {
      ...
      theMutator = new RadamsaDropByteMutator("RadamsaDropByteMutator");
      config = testHelper -> getConfig();
    }

    ~RadamsaDropByteMutatorTest() override = default;
    ...
    RadamsaDropByteMutator* theMutator;
