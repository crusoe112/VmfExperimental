...
using vmf::RadamsaRepeatByteSequenceMutator;
using vmf::BaseException;
using vmf::RuntimeException;

class RadamsaRepeatByteSequenceMutatorTest : public ::testing::Test {
  protected:
    RadamsaRepeatByteSequenceMutatorTest() 
    {
      ...
      theMutator = new RadamsaRepeatByteSequenceMutator("RadamsaRepeatByteSequenceMutator");
      config = testHelper -> getConfig();
    }

    ~RadamsaRepeatByteSequenceMutatorTest() override = default;
    ...
    RadamsaRepeatByteSequenceMutator* theMutator;
...
TEST_F(RadamsaRepeatByteSequenceMutatorTest, BufferSizeGETwo)
{   
    StorageEntry* baseEntry = storage->createNewEntry();
    StorageEntry* modEntry = storage->createNewEntry();
