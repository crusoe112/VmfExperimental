...
using vmf::RadamsaSwapLineMutator;
using vmf::BaseException;
using vmf::RuntimeException;

class RadamsaSwapLineMutatorTest : public ::testing::Test {
  protected:
    RadamsaSwapLineMutatorTest() 
    {
      ...
      theMutator = new RadamsaSwapLineMutator("RadamsaSwapLineMutator");
      config = testHelper -> getConfig();
    }

    ~RadamsaSwapLineMutatorTest() override = default;
    ...
    RadamsaSwapLineMutator* theMutator;
...
TEST_F(RadamsaSwapLineMutatorTest, OneLine)
{    
    StorageEntry* baseEntry = storage->createNewEntry();
    StorageEntry* modEntry = storage->createNewEntry();
