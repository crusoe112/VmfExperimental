...
#include "../vmf/src/modules/common/mutator/RadamsaRandomizeByteMutator.hpp"
...
using vmf::RadamsaRandomizeByteMutator;
using vmf::BaseException;

// #define GTEST_COUT std::cerr << "[          ] [ INFO ]"

class RadamsaRandomizeByteMutatorTest : public ::testing::Test {
  protected:
    RadamsaRandomizeByteMutatorTest() 
    {
      ...
      theMutator = new RadamsaRandomizeByteMutator("RadamsaRandomizeByteMutator");
...
TEST_F(RadamsaRandomizeByteMutatorTest, TestBufferSize)
{
...
TEST_F(RadamsaRandomizeByteMutatorTest, TestRandomize)
{
  StorageEntry* baseEntry = storage->createNewEntry();
  StorageEntry* modEntry = storage->createNewEntry();
