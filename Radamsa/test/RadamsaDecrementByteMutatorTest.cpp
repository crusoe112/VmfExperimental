...
#include "../vmf/src/modules/common/mutator/RadamsaDecrementByteMutator.hpp"
...
using vmf::RadamsaDecrementByteMutator;
using vmf::BaseException;

// #define GTEST_COUT std::cerr << "[          ] [ INFO ]"

class RadamsaDecrementByteMutatorTest : public ::testing::Test {
  protected:
    RadamsaDecrementByteMutatorTest() 
    {
      ...
      theMutator = new RadamsaDecrementByteMutator("RadamsaDecrementByteMutator");
      config = testHelper -> getConfig();
    }

    ~RadamsaDecrementByteMutatorTest() override {}
    ...
    RadamsaDecrementByteMutator* theMutator;
...
TEST_F(RadamsaDecrementByteMutatorTest, TestBufferSize)
{
