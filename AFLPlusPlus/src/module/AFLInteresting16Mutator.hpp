...
{
/**
 * @brief This mutator sets a word to an interesting value.
 * 
 ...
 */
class AFLInteresting16Mutator: public MutatorModule
{
public:
    ...
    AFLInteresting16Mutator(std::string name);
    virtual ~AFLInteresting16Mutator();
