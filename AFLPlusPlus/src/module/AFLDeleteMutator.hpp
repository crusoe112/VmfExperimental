 ...
 * 
 * Note: If the base test case buffer is smaller than 2 bytes, no
 * mutation will occur (instead the input will just be duplicated)
 * 
 ...
 */
class AFLDeleteMutator: public MutatorModule
{
public:
