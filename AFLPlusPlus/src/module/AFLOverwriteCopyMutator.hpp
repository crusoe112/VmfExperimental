...
{
/**
 * @brief This mutator overwrites bytes with another randomly selected chunk of bytes.
 * 
 ...
 */
class AFLOverwriteCopyMutator: public MutatorModule
{
public:
    ...
    AFLOverwriteCopyMutator(std::string name);
    virtual ~AFLOverwriteCopyMutator();
