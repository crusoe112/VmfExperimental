...
{
/**
 * @brief This mutator overwrites bytes with fixed bytes.
 * 
 * There is a 50% chance that the bytes will be overwritten with a randomly chosen byte
 * and a 50% chance that the bytes will be overwritten with a fixed byte chosen from the buffer
 * 
 ...
 */
class AFLOverwriteFixedMutator: public MutatorModule
{
public:
    ...
    AFLOverwriteFixedMutator(std::string name);
    virtual ~AFLOverwriteFixedMutator();
